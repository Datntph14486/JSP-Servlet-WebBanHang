...
<body>
				...
				<article class="col-md-9">
					<div class="row">
						<c:forEach var="product" items="${listProduct.content}">
							<div class="card col-md-4 cl border-1"
								style="margin-top: 20px; margin-right: 20px; width: 30%;">
								<a href="/home/productDetail/${product.id}"> <img
									style="height: 280px"
								...
								<div class="card-body" style="height: 100px">
									<div class="row">
										<p class="card-title text-center text-success">${product.name}</p>
  ...
  <path fill-rule="evenodd"
									...
									<c:if test="${product.available==false}">
										<h5
											class="text-decoration-line-through col-4 text-right text-danger">
											<span>Hết Hàng</span>
										</h5>
									</c:if>
								</div>
					...
					<div>
						<ul class="pagination">
							<c:forEach begin="0" end="${listProduct.totalPages - 1 }"
								varStatus="page">
								<li class="page-item"><a class="page-link"
									href="/home/listProduct/page?p=${page.index + 1}">${page.index+1}</a></li>
							</c:forEach>
						</ul>
